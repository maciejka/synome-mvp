...
public class DerivationTracker implements RuleRuntimeEventListener {
    ...
    /**
     * Mark a fact handle as an explicit delete (base fact removal by the processor).
     * These will be excluded from TMS retraction tracking.
     */
    ...
    public void objectDeleted(ObjectDeletedEvent event) {
        ...
        if (explicitDeletes.contains(handle)) return;
